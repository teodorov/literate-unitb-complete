...
module Language.UnitB.Parser where

    --
    -- Modules
    --
import Language.UnitB.Parser.Machine   as Mch
import Language.UnitB.Parser.Pipeline
import Language.UnitB.Parser.Phase as P
import Language.UnitB.Parser.Phase.Types
import Language.UnitB.Parser.Phase.Structures as Mch
import Language.UnitB.Parser.Phase.Declarations as Mch
import Language.UnitB.Parser.Phase.Expressions as Mch
import Language.UnitB.Parser.Phase.Proofs as Mch
import Language.UnitB.Parser.Visitor hiding (hoistEither)
...
list_file_obligations :: FilePath
                       -> IO (Either [Error] [(Machine, HashMap Label Sequent)])
