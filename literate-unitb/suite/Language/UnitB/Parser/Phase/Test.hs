{-# LANGUAGE OverloadedStrings
    , ConstraintKinds
    #-}
module Language.UnitB.Parser.Phase.Test where

    --
    -- Modules
    --
import Language.UnitB.Parser.Machine
import Language.UnitB.Parser.Phase
import Language.UnitB.Parser.Phase.Types
import Language.UnitB.Parser.Phase.Declarations
import Language.UnitB.Parser.Phase.Expressions
import Language.UnitB.Parser.Phase.Proofs
import Language.UnitB.Parser.Phase.Structures
import Language.UnitB.Parser.Pipeline
import Language.UnitB.Parser.Scope
import Language.UnitB.Parser.ExprScope hiding (var)
import Language.UnitB.Parser.VarScope  hiding (var)
...
prop_inherit_equiv h = forAll (mkMap h) $ \m -> 
    inheritWith' id (L.map.(+)) (++) h m === inheritWithAlt id (L.map.(+)) (++) h (m :: HashMap Int [Int])
