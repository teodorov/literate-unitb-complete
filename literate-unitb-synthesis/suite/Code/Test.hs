...
result0 :: Output
result0 = readFileLn' "expected/Code/result0.txt"
    T.unlines
        [ "data State = State"
        , "    { v_a :: Int" 
        , "    , v_b :: Int" 
...
result1 :: Output
result1 = readFileLn' "expected/Code/result1.txt"
    T.unlines
        [ "let s' = s"
        , "        { v_n = (v_n + 1)"
        , "        , v_a = (v_a + v_b)"
...
result2 :: Output
result2 = readFileLn' "expected/Code/result2.txt"
    T.unlines
        [ "s' = State"
        , "     { v_b = 1"
        , "     , v_c = 6" 
...
result3 :: Output
result3 = readFileLn' "expected/Code/result3.txt"
    T.unlines
        [ "find_cubes c_N = do"
        , "        execState proc s'"
        , "    where"
...
result4 :: Output
result4 = readFileLn' "expected/Code/result4.txt"
    T.unlines
...
result7 :: Output
result7 = readFileLn' "expected/Code/result7.txt"
    T.unlines
        [ "{-# LANGUAGE RecordWildCards #-}"
        , "import Data.Map as M"
        , "import Data.Set as S"
...
result8 :: Output
result8 = readFileLn' "expected/Code/result8.txt"
    T.unlines 
    [ "1000" ]
...
result5 :: Output
result5 = readFileLn' "expected/Code/result5.txt"
    T.unlines
            [ "0^3 = 0"
            , "1^3 = 1"
            , "2^3 = 8"
...
result6 :: Output
result6 = readFileLn' "expected/Code/result6.txt"
    T.unlines 
